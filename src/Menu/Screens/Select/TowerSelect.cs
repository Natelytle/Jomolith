...
public partial class TowerSelect : Control, IScreen
{
    ...
    public void OnResolved()
    {
        ...
        selectLogic.Bind()
            .OnOutput<TowerSelectState.Output.TowerListUpdated>((in o) => populateList(o.Towers))
        ...
        selectLogic.Start<TowerSelectState.Browsing>();
    }
    ...
    {
        selectLogic.Input(new TowerSelectState.Input.LoadComplete(towerRepository.LoadAllTowers()));
    }
