...
public class CornerWedgeShapeBuilder : ShapeBuilder
{
    public override Mesh BuildMesh(PartModel part) => BuildWedgeMesh(true);
    ...
    public override float GetVolume(PartModel part) => part.Scale.X * part.Scale.Y * part.Scale.Z / 3.0f;
}
